      ...
      await fetch(`${STRAPI_URL}/api/orders/${orderId}`, {
        ...
        body: JSON.stringify({
          data: {
            ...
            // ⚠️ "label_created" significa: la guía de Envia ya existe (se generó y
            //    se cobró). NO significa que el paquete ya salió físicamente —
            //    eso Envia lo maneja aparte (recolección/tránsito).
