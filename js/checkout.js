...
<script
  ...
  data-api-key="${buttonConfig.apiKey}"
  data-order-id="${buttonConfig.orderId}"
  data-amount="${buttonConfig.amount}"
  data-currency="${buttonConfig.currency}"
  data-integrity-signature="${buttonConfig.integritySignature}"
  data-redirection-url="${buttonConfig.redirectionUrl}"
  data-description="${buttonConfig.description}">
</script>
`

setTimeout(() => {
  const button = document.querySelector('[data-bold-button]')
