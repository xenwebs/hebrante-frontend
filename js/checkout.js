...
async function processPaymentWithBold(cart, formData, orderId) {
  ...
  try {
    ...
    button.setAttribute("data-bold-button", "dark-M")
    button.setAttribute("data-api-key", buttonConfig.apiKey)
    button.setAttribute("data-order-id", buttonConfig.orderId)
    button.setAttribute("data-amount", buttonConfig.amount)
    button.setAttribute("data-currency", buttonConfig.currency)
    button.setAttribute(
    ...
    console.log("✅ Bold button inserted")
