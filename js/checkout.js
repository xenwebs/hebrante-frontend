...
function showPromoError(message) {
  ...
  if (errorEl) {
    ...
    errorEl.style.color = "#FF9800"        // оранжевая
  ...
  // Добавить стиль к input чтоб было видно ошибку
  if (promoInput) {
    promoInput.style.borderColor = "#FF9800"
    promoInput.style.backgroundColor = "rgba(255, 152, 0, 0.05)"
  }
}
