...
export async function loadProduct() {
  try {
    ...
    // ✅ Жди 300ms перед инициализацией UI (чтобы DOM обновился)
    ...
    // ✅ ВАЖНО: дополнительная задержка перед скрытием прелоадера
    await new Promise(resolve => setTimeout(resolve, 300));
    ...
    setTimeout(() => {
      ...
      // ✅ Скрываем прелоадер с задержкой (700ms = 0.7 сек для плавного скрытия)
      preloader.hide(700);
    }, 100);
